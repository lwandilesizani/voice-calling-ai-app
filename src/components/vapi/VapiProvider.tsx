...
export const VapiProvider: React.FC<VapiProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      // Use the VAPI_API_KEY instead of NEXT_PUBLIC_VAPI_PUBLIC_KEY
      // The key needs to be a public key, not a secret key
      ...
      try {
        console.log('Initializing Vapi with key:', publicKey);
